...
def get_range(start, end):
    ...
    return [(x,y) for x in range(start[0], end[0]+x_dir, x_dir) for y in range(start[1], end[1]+y_dir, y_dir)]
...
def count_overlaps(data):
    ...
    for line in data:
        ...
        if start[0] == end[0] or start[1] == end[1]: # Horizontal or vertical
...
def test_cases():
    verify(count_overlaps(example1), 5)
